...
- `day / night / away` native climate presets with internal `antifreeze` protection;
...
Version `0.1.2` is still an **experimental pre-release implementation**. Unit/CI and container-build validation are automated. The remaining release gate is end-to-end testing on a real Home Assistant OS installation with real MQTT discovery and physical actuator entities.
